...
export default function Pricing() {
  ...
  // Define plans without Stripe integration
  const plans = [
    {
      name: 'Starter',
  ...
  // Simplified plan selection that just shows a message
  async function handleSelectPlan() {
    alert('Subscription functionality has been temporarily disabled. All features are currently available to all users for free.');
  }

  return (
    <div className="min-h-screen bg-black">
      <div className="bg-blue-600 text-white text-center py-2 mb-4">
        All plans are currently available for free - Stripe integration has been removed
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            ...
            All plans are temporarily free while we rebuild our payment system.
          </p>
        </div>
